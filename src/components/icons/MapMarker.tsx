...
const MapMarker = () => {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path fillRule="evenodd" clipRule="evenodd" d="M12.092 8.92543C12.092 7.77437 11.1593 6.84167 10.0082 6.84167C8.85799 6.84167 7.92529 7.77437 7.92529 8.92543C7.92529 10.0756 8.85799 11.0083 10.0082 11.0083C11.1593 11.0083 12.092 10.0756 12.092 8.92543Z" stroke="#46A358" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
