...
const App = () => {
  ...
  useEffect(() => {
    axios.get('https://gist.githubusercontent.com/Korgehah/f8dc7a61bb82eb51428427bcdd666857/raw/84f401829838200ebf08e3794869d4c3a817600a/productCards.json')
      .then(({ data }) => setPlants(data));
    axios.get('https://gist.githubusercontent.com/Korgehah/97a70084d5c1566b0349b77663a556b5/raw/3b6ed5e6dc9801cd1cc472b83f6f3a49660b0e3b/blog.json')
  ...
  return (
    <div className={classes.wrapper}>
      <div className={classes.app}>
        ...
        <RelatedProducts title='Related Products' products={plants.slice(0, 15)} />
